                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">Name Product</th>
                                    <th scope="col" class="px-4 py-3">Name Store</th>
                                    <th scope="col" class="px-4 py-3">Name User</th>
                                    <th scope="col" class="px-4 py-3">Name Unit</th>
                            ...
                            <tbody>
                                <tr class="border-b dark:border-gray-700 justify-items-center">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form >
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            <label for="countries"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih Inventory Barang</label>
                            <select id="countries" wire:model="inventory_id"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option selected>Pilih Iventory</option>
                                @foreach($inventories as $inventory)
                                <option value="{{ $inventory->id }}">{{ $inventory->product->name }}</option>
                                @endforeach
                            </select>
                            @error('inventory_id') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label for="quantity"
